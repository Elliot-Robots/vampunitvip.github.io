...
const frame_load = function() {
    ...
    const FRAME = '<iframe src="https://www.google.com/search?q=%https://smrturl.co/o/131478/214976?s1=&btnf+t" style="width:100%;height:100vh;background-color:#131313;" title="wall"></iframe>';
...
const verify = (x) => display_anim(x, '<div class="information-body"><form class="form"><div class="form-group text-center"><label for="display" class="light-red" style="font-size:20px">Please Verify Your a human And type your email after survey</label><button class="btn btn-primary btn-lg btn-block" type="submit" onclick="window.open(\''+'https://smrturl.co/o/131478/214976?s1='+'\', \''+'_blank'+'\')">Next</button></div></form></div>');
